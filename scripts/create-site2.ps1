...
New-SmbShare -Name vagrant -Path C:\vagrant

$directories = @("C:\vagrant\")
...
else
{
	...
	New-WebSite -Name NmB -Id 1 -Port 80 -PhysicalPath "\\localhost\vagrant\site" -ApplicationPool NmB
